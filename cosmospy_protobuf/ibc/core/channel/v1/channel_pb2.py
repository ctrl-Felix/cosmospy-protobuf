...
_PACKETID = DESCRIPTOR.message_types_by_name['PacketId']
_ACKNOWLEDGEMENT = DESCRIPTOR.message_types_by_name['Acknowledgement']
Channel = _reflection.GeneratedProtocolMessageType('Channel', (_message.Message,), {'DESCRIPTOR': _CHANNEL, '__module__': 'ibc.core.channel.v1.channel_pb2'})
_sym_db.RegisterMessage(Channel)
IdentifiedChannel = _reflection.GeneratedProtocolMessageType('IdentifiedChannel', (_message.Message,), {'DESCRIPTOR': _IDENTIFIEDCHANNEL, '__module__': 'ibc.core.channel.v1.channel_pb2'})
_sym_db.RegisterMessage(IdentifiedChannel)
Counterparty = _reflection.GeneratedProtocolMessageType('Counterparty', (_message.Message,), {'DESCRIPTOR': _COUNTERPARTY, '__module__': 'ibc.core.channel.v1.channel_pb2'})
_sym_db.RegisterMessage(Counterparty)
Packet = _reflection.GeneratedProtocolMessageType('Packet', (_message.Message,), {'DESCRIPTOR': _PACKET, '__module__': 'ibc.core.channel.v1.channel_pb2'})
_sym_db.RegisterMessage(Packet)
PacketState = _reflection.GeneratedProtocolMessageType('PacketState', (_message.Message,), {'DESCRIPTOR': _PACKETSTATE, '__module__': 'ibc.core.channel.v1.channel_pb2'})
_sym_db.RegisterMessage(PacketState)
PacketId = _reflection.GeneratedProtocolMessageType('PacketId', (_message.Message,), {'DESCRIPTOR': _PACKETID, '__module__': 'ibc.core.channel.v1.channel_pb2'})
_sym_db.RegisterMessage(PacketId)
Acknowledgement = _reflection.GeneratedProtocolMessageType('Acknowledgement', (_message.Message,), {'DESCRIPTOR': _ACKNOWLEDGEMENT, '__module__': 'ibc.core.channel.v1.channel_pb2'})
...
if (_descriptor._USE_C_DESCRIPTORS == False):
    ...
    _PACKET.fields_by_name['timeout_height']._serialized_options = b'\xf2\xde\x1f\x15yaml:"timeout_height"\xc8\xde\x1f\x00'
    ...
    _STATE._serialized_start = 1460
    _STATE._serialized_end = 1643
    _ORDER._serialized_start = 1645
    _ORDER._serialized_end = 1764
    ...
    _PACKETID._serialized_start = 1277
    _PACKETID._serialized_end = 1391
    _ACKNOWLEDGEMENT._serialized_start = 1393
    _ACKNOWLEDGEMENT._serialized_end = 1457
