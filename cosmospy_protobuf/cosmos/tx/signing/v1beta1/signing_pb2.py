...
SignatureDescriptors = _reflection.GeneratedProtocolMessageType('SignatureDescriptors', (_message.Message,), {'DESCRIPTOR': _SIGNATUREDESCRIPTORS, '__module__': 'cosmos.tx.signing.v1beta1.signing_pb2'})
_sym_db.RegisterMessage(SignatureDescriptors)
SignatureDescriptor = _reflection.GeneratedProtocolMessageType('SignatureDescriptor', (_message.Message,), {'Data': _reflection.GeneratedProtocolMessageType('Data', (_message.Message,), {'Single': _reflection.GeneratedProtocolMessageType('Single', (_message.Message,), {'DESCRIPTOR': _SIGNATUREDESCRIPTOR_DATA_SINGLE, '__module__': 'cosmos.tx.signing.v1beta1.signing_pb2'}), 'Multi': _reflection.GeneratedProtocolMessageType('Multi', (_message.Message,), {'DESCRIPTOR': _SIGNATUREDESCRIPTOR_DATA_MULTI, '__module__': 'cosmos.tx.signing.v1beta1.signing_pb2'}), 'DESCRIPTOR': _SIGNATUREDESCRIPTOR_DATA, '__module__': 'cosmos.tx.signing.v1beta1.signing_pb2'}), 'DESCRIPTOR': _SIGNATUREDESCRIPTOR, '__module__': 'cosmos.tx.signing.v1beta1.signing_pb2'})
