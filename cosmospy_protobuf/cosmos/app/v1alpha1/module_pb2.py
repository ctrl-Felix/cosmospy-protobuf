...
ModuleDescriptor = _reflection.GeneratedProtocolMessageType('ModuleDescriptor', (_message.Message,), {
...
PackageReference = _reflection.GeneratedProtocolMessageType('PackageReference', (_message.Message,), {
...
MigrateFromInfo = _reflection.GeneratedProtocolMessageType('MigrateFromInfo', (_message.Message,), {
