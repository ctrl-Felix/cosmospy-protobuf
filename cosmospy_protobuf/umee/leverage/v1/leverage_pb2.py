...
if (_descriptor._USE_C_DESCRIPTORS == False):
    ...
    _TOKEN.fields_by_name['enable_msg_lend']._options = None
    _TOKEN.fields_by_name['enable_msg_lend']._serialized_options = b'\xf2\xde\x1f\x16yaml:"enable_msg_lend"'
    _TOKEN.fields_by_name['enable_msg_borrow']._options = None
    _TOKEN.fields_by_name['enable_msg_borrow']._serialized_options = b'\xf2\xde\x1f\x18yaml:"enable_msg_borrow"'
    _TOKEN._options = None
    _TOKEN._serialized_options = b'\xe8\xa0\x1f\x01'
    _PARAMS._serialized_start = 88
    _PARAMS._serialized_end = 562
    _TOKEN._serialized_start = 565
    _TOKEN._serialized_end = 1670
