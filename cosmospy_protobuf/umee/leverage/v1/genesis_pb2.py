...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n\x1eumee/leverage/v1/genesis.proto\x12\x1cumeenetwork.umee.leverage.v1\x1a\x1ecosmos/base/v1beta1/coin.proto\x1a\x1fumee/leverage/v1/leverage.proto\x1a\x14gogoproto/gogo.proto"\xda\x05\n\x0cGenesisState\x12:\n\x06params\x18\x01 \x01(\x0b2$.umeenetwork.umee.leverage.v1.ParamsB\x04\xc8\xde\x1f\x00\x12;\n\x08registry\x18\x02 \x03(\x0b2#.umeenetwork.umee.leverage.v1.TokenB\x04\xc8\xde\x1f\x00\x12L\n\x10adjusted_borrows\x18\x03 \x03(\x0b2,.umeenetwork.umee.leverage.v1.AdjustedBorrowB\x04\xc8\xde\x1f\x00\x12R\n\x13collateral_settings\x18\x04 \x03(\x0b2/.umeenetwork.umee.leverage.v1.CollateralSettingB\x04\xc8\xde\x1f\x00\x12B\n\ncollateral\x18\x05 \x03(\x0b2(.umeenetwork.umee.leverage.v1.CollateralB\x04\xc8\xde\x1f\x00\x12]\n\x08reserves\x18\x06 \x03(\x0b2\x19.cosmos.base.v1beta1.CoinB0\xc8\xde\x1f\x00\xaa\xdf\x1f(github.com/cosmos/cosmos-sdk/types.Coins\x12\x1a\n\x12last_interest_time\x18\x07 \x01(\x03\x12>\n\tbad_debts\x18\x08 \x03(\x0b2%.umeenetwork.umee.leverage.v1.BadDebtB\x04\xc8\xde\x1f\x00\x12L\n\x10interest_scalars\x18\t \x03(\x0b2,.umeenetwork.umee.leverage.v1.InterestScalarB\x04\xc8\xde\x1f\x00\x12b\n\rutoken_supply\x18\n \x03(\x0b2\x19.cosmos.base.v1beta1.CoinB0\xc8\xde\x1f\x00\xaa\xdf\x1f(github.com/cosmos/cosmos-sdk/types.Coins"U\n\x0eAdjustedBorrow\x12\x0f\n\x07address\x18\x01 \x01(\t\x122\n\x06amount\x18\x02 \x01(\x0b2\x1c.cosmos.base.v1beta1.DecCoinB\x04\xc8\xde\x1f\x00"3\n\x11CollateralSetting\x12\x0f\n\x07address\x18\x01 \x01(\t\x12\r\n\x05denom\x18\x02 \x01(\t"N\n\nCollateral\x12\x0f\n\x07address\x18\x01 \x01(\t\x12/\n\x06amount\x18\x02 \x01(\x0b2\x19.cosmos.base.v1beta1.CoinB\x04\xc8\xde\x1f\x00")\n\x07BadDebt\x12\x0f\n\x07address\x18\x01 \x01(\t\x12\r\n\x05denom\x18\x02 \x01(\t"_\n\x0eInterestScalar\x12\r\n\x05denom\x18\x01 \x01(\t\x12>\n\x06scalar\x18\x02 \x01(\tB.\xda\xde\x1f&github.com/cosmos/cosmos-sdk/types.Dec\xc8\xde\x1f\x00B2Z0github.com/umee-network/umee/v2/x/leverage/typesb\x06proto3')
...
GenesisState = _reflection.GeneratedProtocolMessageType('GenesisState', (_message.Message,), {'DESCRIPTOR': _GENESISSTATE, '__module__': 'umee.leverage.v1.genesis_pb2'})
_sym_db.RegisterMessage(GenesisState)
AdjustedBorrow = _reflection.GeneratedProtocolMessageType('AdjustedBorrow', (_message.Message,), {'DESCRIPTOR': _ADJUSTEDBORROW, '__module__': 'umee.leverage.v1.genesis_pb2'})
_sym_db.RegisterMessage(AdjustedBorrow)
CollateralSetting = _reflection.GeneratedProtocolMessageType('CollateralSetting', (_message.Message,), {'DESCRIPTOR': _COLLATERALSETTING, '__module__': 'umee.leverage.v1.genesis_pb2'})
_sym_db.RegisterMessage(CollateralSetting)
Collateral = _reflection.GeneratedProtocolMessageType('Collateral', (_message.Message,), {'DESCRIPTOR': _COLLATERAL, '__module__': 'umee.leverage.v1.genesis_pb2'})
_sym_db.RegisterMessage(Collateral)
BadDebt = _reflection.GeneratedProtocolMessageType('BadDebt', (_message.Message,), {'DESCRIPTOR': _BADDEBT, '__module__': 'umee.leverage.v1.genesis_pb2'})
_sym_db.RegisterMessage(BadDebt)
InterestScalar = _reflection.GeneratedProtocolMessageType('InterestScalar', (_message.Message,), {'DESCRIPTOR': _INTERESTSCALAR, '__module__': 'umee.leverage.v1.genesis_pb2'})
...
if (_descriptor._USE_C_DESCRIPTORS == False):
    ...
    _GENESISSTATE._serialized_end = 882
    _ADJUSTEDBORROW._serialized_start = 884
    _ADJUSTEDBORROW._serialized_end = 969
    _COLLATERALSETTING._serialized_start = 971
    _COLLATERALSETTING._serialized_end = 1022
    _COLLATERAL._serialized_start = 1024
    _COLLATERAL._serialized_end = 1102
    _BADDEBT._serialized_start = 1104
    _BADDEBT._serialized_end = 1145
    _INTERESTSCALAR._serialized_start = 1147
    _INTERESTSCALAR._serialized_end = 1242
