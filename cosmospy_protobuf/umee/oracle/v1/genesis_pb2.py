...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n\x1cumee/oracle/v1/genesis.proto\x12\x1aumeenetwork.umee.oracle.v1\x1a\x14gogoproto/gogo.proto\x1a\x1bumee/oracle/v1/oracle.proto"\x8f\x04\n\x0cGenesisState\x128\n\x06params\x18\x01 \x01(\x0b2".umeenetwork.umee.oracle.v1.ParamsB\x04\xc8\xde\x1f\x00\x12N\n\x12feeder_delegations\x18\x02 \x03(\x0b2,.umeenetwork.umee.oracle.v1.FeederDelegationB\x04\xc8\xde\x1f\x00\x12a\n\x0eexchange_rates\x18\x03 \x03(\x0b2-.umeenetwork.umee.oracle.v1.ExchangeRateTupleB\x1a\xaa\xdf\x1f\x12ExchangeRateTuples\xc8\xde\x1f\x00\x12D\n\rmiss_counters\x18\x04 \x03(\x0b2\'.umeenetwork.umee.oracle.v1.MissCounterB\x04\xc8\xde\x1f\x00\x12h\n aggregate_exchange_rate_prevotes\x18\x05 \x03(\x0b28.umeenetwork.umee.oracle.v1.AggregateExchangeRatePrevoteB\x04\xc8\xde\x1f\x00\x12b\n\x1daggregate_exchange_rate_votes\x18\x06 \x03(\x0b25.umeenetwork.umee.oracle.v1.AggregateExchangeRateVoteB\x04\xc8\xde\x1f\x00"E\n\x10FeederDelegation\x12\x16\n\x0efeeder_address\x18\x01 \x01(\t\x12\x19\n\x11validator_address\x18\x02 \x01(\t">\n\x0bMissCounter\x12\x19\n\x11validator_address\x18\x01 \x01(\t\x12\x14\n\x0cmiss_counter\x18\x02 \x01(\x04B0Z.github.com/umee-network/umee/v2/x/oracle/typesb\x06proto3')
...
GenesisState = _reflection.GeneratedProtocolMessageType('GenesisState', (_message.Message,), {'DESCRIPTOR': _GENESISSTATE, '__module__': 'umee.oracle.v1.genesis_pb2'})
_sym_db.RegisterMessage(GenesisState)
FeederDelegation = _reflection.GeneratedProtocolMessageType('FeederDelegation', (_message.Message,), {'DESCRIPTOR': _FEEDERDELEGATION, '__module__': 'umee.oracle.v1.genesis_pb2'})
_sym_db.RegisterMessage(FeederDelegation)
MissCounter = _reflection.GeneratedProtocolMessageType('MissCounter', (_message.Message,), {'DESCRIPTOR': _MISSCOUNTER, '__module__': 'umee.oracle.v1.genesis_pb2'})
...
if (_descriptor._USE_C_DESCRIPTORS == False):
    ...
    _GENESISSTATE._serialized_end = 639
    _FEEDERDELEGATION._serialized_start = 641
    _FEEDERDELEGATION._serialized_end = 710
    _MISSCOUNTER._serialized_start = 712
    _MISSCOUNTER._serialized_end = 774
