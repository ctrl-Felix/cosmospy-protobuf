...
Params = _reflection.GeneratedProtocolMessageType('Params', (_message.Message,), {'DESCRIPTOR': _PARAMS, '__module__': 'umee.oracle.v1.oracle_pb2'})
_sym_db.RegisterMessage(Params)
Denom = _reflection.GeneratedProtocolMessageType('Denom', (_message.Message,), {'DESCRIPTOR': _DENOM, '__module__': 'umee.oracle.v1.oracle_pb2'})
_sym_db.RegisterMessage(Denom)
AggregateExchangeRatePrevote = _reflection.GeneratedProtocolMessageType('AggregateExchangeRatePrevote', (_message.Message,), {'DESCRIPTOR': _AGGREGATEEXCHANGERATEPREVOTE, '__module__': 'umee.oracle.v1.oracle_pb2'})
_sym_db.RegisterMessage(AggregateExchangeRatePrevote)
AggregateExchangeRateVote = _reflection.GeneratedProtocolMessageType('AggregateExchangeRateVote', (_message.Message,), {'DESCRIPTOR': _AGGREGATEEXCHANGERATEVOTE, '__module__': 'umee.oracle.v1.oracle_pb2'})
_sym_db.RegisterMessage(AggregateExchangeRateVote)
ExchangeRateTuple = _reflection.GeneratedProtocolMessageType('ExchangeRateTuple', (_message.Message,), {'DESCRIPTOR': _EXCHANGERATETUPLE, '__module__': 'umee.oracle.v1.oracle_pb2'})
...
if (_descriptor._USE_C_DESCRIPTORS == False):
    ...
    _PARAMS._serialized_end = 758
    _DENOM._serialized_start = 761
    _DENOM._serialized_end = 911
    _AGGREGATEEXCHANGERATEPREVOTE._serialized_start = 914
    _AGGREGATEEXCHANGERATEPREVOTE._serialized_end = 1069
    _AGGREGATEEXCHANGERATEVOTE._serialized_start = 1072
    _AGGREGATEEXCHANGERATEVOTE._serialized_end = 1283
    _EXCHANGERATETUPLE._serialized_start = 1286
    _EXCHANGERATETUPLE._serialized_end = 1447
