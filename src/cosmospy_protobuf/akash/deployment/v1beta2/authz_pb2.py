...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n$akash/deployment/v1beta2/authz.proto\x12\x18akash.deployment.v1beta2\x1a\x14gogoproto/gogo.proto\x1a\x19cosmos_proto/cosmos.proto\x1a\x1ecosmos/base/v1beta1/coin.proto"x\n\x1eDepositDeploymentAuthorization\x12C\n\x0bspend_limit\x18\x01 \x01(\x0b2\x19.cosmos.base.v1beta1.CoinB\x13\xc8\xde\x1f\x00\xea\xde\x1f\x0bspend_limit:\x11\xca\xb4-\rAuthorizationB4Z2github.com/ovrclk/akash/x/deployment/types/v1beta2b\x06proto3')
_DEPOSITDEPLOYMENTAUTHORIZATION = DESCRIPTOR.message_types_by_name['DepositDeploymentAuthorization']
DepositDeploymentAuthorization = _reflection.GeneratedProtocolMessageType('DepositDeploymentAuthorization', (_message.Message,), {'DESCRIPTOR': _DEPOSITDEPLOYMENTAUTHORIZATION, '__module__': 'akash.deployment.v1beta2.authz_pb2'})
