...
ProviderInfo = _reflection.GeneratedProtocolMessageType('ProviderInfo', (_message.Message,), {'DESCRIPTOR': _PROVIDERINFO, '__module__': 'akash.provider.v1beta1.provider_pb2'})
_sym_db.RegisterMessage(ProviderInfo)
MsgCreateProvider = _reflection.GeneratedProtocolMessageType('MsgCreateProvider', (_message.Message,), {'DESCRIPTOR': _MSGCREATEPROVIDER, '__module__': 'akash.provider.v1beta1.provider_pb2'})
_sym_db.RegisterMessage(MsgCreateProvider)
MsgCreateProviderResponse = _reflection.GeneratedProtocolMessageType('MsgCreateProviderResponse', (_message.Message,), {'DESCRIPTOR': _MSGCREATEPROVIDERRESPONSE, '__module__': 'akash.provider.v1beta1.provider_pb2'})
_sym_db.RegisterMessage(MsgCreateProviderResponse)
MsgUpdateProvider = _reflection.GeneratedProtocolMessageType('MsgUpdateProvider', (_message.Message,), {'DESCRIPTOR': _MSGUPDATEPROVIDER, '__module__': 'akash.provider.v1beta1.provider_pb2'})
_sym_db.RegisterMessage(MsgUpdateProvider)
MsgUpdateProviderResponse = _reflection.GeneratedProtocolMessageType('MsgUpdateProviderResponse', (_message.Message,), {'DESCRIPTOR': _MSGUPDATEPROVIDERRESPONSE, '__module__': 'akash.provider.v1beta1.provider_pb2'})
_sym_db.RegisterMessage(MsgUpdateProviderResponse)
MsgDeleteProvider = _reflection.GeneratedProtocolMessageType('MsgDeleteProvider', (_message.Message,), {'DESCRIPTOR': _MSGDELETEPROVIDER, '__module__': 'akash.provider.v1beta1.provider_pb2'})
_sym_db.RegisterMessage(MsgDeleteProvider)
MsgDeleteProviderResponse = _reflection.GeneratedProtocolMessageType('MsgDeleteProviderResponse', (_message.Message,), {'DESCRIPTOR': _MSGDELETEPROVIDERRESPONSE, '__module__': 'akash.provider.v1beta1.provider_pb2'})
_sym_db.RegisterMessage(MsgDeleteProviderResponse)
Provider = _reflection.GeneratedProtocolMessageType('Provider', (_message.Message,), {'DESCRIPTOR': _PROVIDER, '__module__': 'akash.provider.v1beta1.provider_pb2'})
_sym_db.RegisterMessage(Provider)
_MSG = DESCRIPTOR.services_by_name['Msg']
if (_descriptor._USE_C_DESCRIPTORS == False):
    DESCRIPTOR._options = None
    DESCRIPTOR._serialized_options = b'Z0github.com/ovrclk/akash/x/provider/types/v1beta1'
    ...
    _MSGCREATEPROVIDER.fields_by_name['attributes']._serialized_options = b'\xaa\xdf\x1f0github.com/ovrclk/akash/types/v1beta1.Attributes\xc8\xde\x1f\x00\xea\xde\x1f\nattributes\xf2\xde\x1f\x11yaml:"attributes"'
    ...
    _MSGUPDATEPROVIDER.fields_by_name['attributes']._serialized_options = b'\xaa\xdf\x1f0github.com/ovrclk/akash/types/v1beta1.Attributes\xc8\xde\x1f\x00\xea\xde\x1f\nattributes\xf2\xde\x1f\x11yaml:"attributes"'
