...
Provider = _reflection.GeneratedProtocolMessageType('Provider', (_message.Message,), {'DESCRIPTOR': _PROVIDER, '__module__': 'akash.audit.v1beta2.audit_pb2'})
_sym_db.RegisterMessage(Provider)
AuditedAttributes = _reflection.GeneratedProtocolMessageType('AuditedAttributes', (_message.Message,), {'DESCRIPTOR': _AUDITEDATTRIBUTES, '__module__': 'akash.audit.v1beta2.audit_pb2'})
_sym_db.RegisterMessage(AuditedAttributes)
AttributesResponse = _reflection.GeneratedProtocolMessageType('AttributesResponse', (_message.Message,), {'DESCRIPTOR': _ATTRIBUTESRESPONSE, '__module__': 'akash.audit.v1beta2.audit_pb2'})
_sym_db.RegisterMessage(AttributesResponse)
AttributesFilters = _reflection.GeneratedProtocolMessageType('AttributesFilters', (_message.Message,), {'DESCRIPTOR': _ATTRIBUTESFILTERS, '__module__': 'akash.audit.v1beta2.audit_pb2'})
_sym_db.RegisterMessage(AttributesFilters)
MsgSignProviderAttributes = _reflection.GeneratedProtocolMessageType('MsgSignProviderAttributes', (_message.Message,), {'DESCRIPTOR': _MSGSIGNPROVIDERATTRIBUTES, '__module__': 'akash.audit.v1beta2.audit_pb2'})
_sym_db.RegisterMessage(MsgSignProviderAttributes)
MsgSignProviderAttributesResponse = _reflection.GeneratedProtocolMessageType('MsgSignProviderAttributesResponse', (_message.Message,), {'DESCRIPTOR': _MSGSIGNPROVIDERATTRIBUTESRESPONSE, '__module__': 'akash.audit.v1beta2.audit_pb2'})
_sym_db.RegisterMessage(MsgSignProviderAttributesResponse)
MsgDeleteProviderAttributes = _reflection.GeneratedProtocolMessageType('MsgDeleteProviderAttributes', (_message.Message,), {'DESCRIPTOR': _MSGDELETEPROVIDERATTRIBUTES, '__module__': 'akash.audit.v1beta2.audit_pb2'})
_sym_db.RegisterMessage(MsgDeleteProviderAttributes)
MsgDeleteProviderAttributesResponse = _reflection.GeneratedProtocolMessageType('MsgDeleteProviderAttributesResponse', (_message.Message,), {'DESCRIPTOR': _MSGDELETEPROVIDERATTRIBUTESRESPONSE, '__module__': 'akash.audit.v1beta2.audit_pb2'})
...
if (_descriptor._USE_C_DESCRIPTORS == False):
    ...
    _AUDITEDATTRIBUTES.fields_by_name['attributes']._serialized_options = b'\xaa\xdf\x1f0github.com/ovrclk/akash/types/v1beta2.Attributes\xc8\xde\x1f\x00\xea\xde\x1f\nattributes\xf2\xde\x1f\x11yaml:"attributes"'
    ...
    _MSGSIGNPROVIDERATTRIBUTES.fields_by_name['attributes']._serialized_options = b'\xaa\xdf\x1f0github.com/ovrclk/akash/types/v1beta2.Attributes\xc8\xde\x1f\x00\xea\xde\x1f\nattributes\xf2\xde\x1f\x11yaml:"attributes"'
