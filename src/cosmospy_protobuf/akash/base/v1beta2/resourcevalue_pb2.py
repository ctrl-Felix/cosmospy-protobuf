...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n&akash/base/v1beta2/resourcevalue.proto\x12\x12akash.base.v1beta2\x1a\x14gogoproto/gogo.proto"R\n\rResourceValue\x12;\n\x03val\x18\x01 \x01(\x0cB.\xc8\xde\x1f\x00\xda\xde\x1f&github.com/cosmos/cosmos-sdk/types.Int:\x04\xe8\xa0\x1f\x01B\'Z%github.com/ovrclk/akash/types/v1beta2b\x06proto3')
_RESOURCEVALUE = DESCRIPTOR.message_types_by_name['ResourceValue']
ResourceValue = _reflection.GeneratedProtocolMessageType('ResourceValue', (_message.Message,), {'DESCRIPTOR': _RESOURCEVALUE, '__module__': 'akash.base.v1beta2.resourcevalue_pb2'})
