...
Attribute = _reflection.GeneratedProtocolMessageType('Attribute', (_message.Message,), {'DESCRIPTOR': _ATTRIBUTE, '__module__': 'akash.base.v1beta2.attribute_pb2'})
_sym_db.RegisterMessage(Attribute)
SignedBy = _reflection.GeneratedProtocolMessageType('SignedBy', (_message.Message,), {'DESCRIPTOR': _SIGNEDBY, '__module__': 'akash.base.v1beta2.attribute_pb2'})
_sym_db.RegisterMessage(SignedBy)
PlacementRequirements = _reflection.GeneratedProtocolMessageType('PlacementRequirements', (_message.Message,), {'DESCRIPTOR': _PLACEMENTREQUIREMENTS, '__module__': 'akash.base.v1beta2.attribute_pb2'})
_sym_db.RegisterMessage(PlacementRequirements)
if (_descriptor._USE_C_DESCRIPTORS == False):
    DESCRIPTOR._options = None
    DESCRIPTOR._serialized_options = b'Z%github.com/ovrclk/akash/types/v1beta2\xd8\xe1\x1e\x00\x80\xe2\x1e\x00'
