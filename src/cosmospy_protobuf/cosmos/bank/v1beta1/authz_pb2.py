...
SendAuthorization = _reflection.GeneratedProtocolMessageType('SendAuthorization', (_message.Message,), {'DESCRIPTOR': _SENDAUTHORIZATION, '__module__': 'cosmos.bank.v1beta1.authz_pb2'})
