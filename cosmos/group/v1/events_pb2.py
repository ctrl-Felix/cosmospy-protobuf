...
EventSubmitProposal = _reflection.GeneratedProtocolMessageType('EventSubmitProposal', (_message.Message,), {
...
EventWithdrawProposal = _reflection.GeneratedProtocolMessageType('EventWithdrawProposal', (_message.Message,), {
...
EventLeaveGroup = _reflection.GeneratedProtocolMessageType('EventLeaveGroup', (_message.Message,), {
