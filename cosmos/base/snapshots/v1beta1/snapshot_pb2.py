...
SnapshotKVItem = _reflection.GeneratedProtocolMessageType('SnapshotKVItem', (_message.Message,), {
...
SnapshotSchema = _reflection.GeneratedProtocolMessageType('SnapshotSchema', (_message.Message,), {
